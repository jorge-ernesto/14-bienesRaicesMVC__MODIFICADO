<fieldset>
    ...
    <textarea id="descripcion" name="propiedad[descripcion]" placeholder="Descripción Propiedad (Si usas una palabra muy grande el diseño no valdra, usar Lorem Ipsum)"><?php echo s($propiedad->descripcion); ?></textarea>
